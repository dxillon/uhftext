...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    // Button animations
    const buttons = [contactButtonRef.current].filter(Boolean);
    ...
    `}
      ...
      rgba(255, 0, 0, 0.05)
              ...
              >
                ...
                <span className="text-white/70 select-none flex-shrink-0">
                  |
                </span>
          ...
          <div className="col-span-5 pt-4 mt-4 border-t border-gray-700 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center justify-center gap-5">
              ...
              <motion.a
                ...
                title="Visit Bishan's Portfolio"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Twitter (X) – Urban Hustle Films"
                whileHover={{ scale: 1.2, color: "#ccc5b9" }}
                transition={{ duration: 0.3 }}
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn – Urban Hustle Films"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram – Urban Hustle Films"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Threads – Urban Hustle Films"
                whileHover={{ scale: 1.2, color: "#c3baba" }}
                transition={{ duration: 0.3 }}
                style={{ fontSize: "1.5rem", color: "white" }}
              >
                <BsThreads />
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube – Urban Hustle Films"
              ...
              <motion.button
                onClick={() => navigate("/qr")}
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800 hover:bg-red-600 transition-colors group"
    ...
    `}
          ...
          <div className="flex justify-center">
            <div className="flex flex-wrap items-center justify-center gap-3">
              <SocialIcon
                icon={BsTwitterX}
                href="https://x.com/urbanhustlefilm"
                label="Twitter (X) – Urban Hustle Films"
              />
              <SocialIcon
                icon={FaLinkedinIn}
                href="https://www.linkedin.com/company/urbanhustlefilms/"
                label="LinkedIn – Urban Hustle Films"
              />
              <SocialIcon
                icon={Instagram}
                href="https://www.instagram.com/urbanhustlefilms"
                label="Instagram – Urban Hustle Films"
              />
              <SocialIcon
                icon={BsThreads}
                href="https://www.threads.net/@urbanhustlefilms"
                label="Threads – Urban Hustle Films"
              />
              <SocialIcon
                icon={Facebook}
                href="https://www.facebook.com/people/Urban-Hustle-Films/61573424103083"
                label="Facebook – Urban Hustle Films"
              />
              <SocialIcon
                icon={Youtube}
                href="https://www.youtube.com/@urbanhustlefilms"
                label="YouTube – Urban Hustle Films"
              />
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-center">
            <div className="text-gray-300 text-base md:text-lg flex items-center gap-3 select-none">
              ...
              <span className="font-semibold text-white">Have questions?</span>
              <Link
                to="/faq"
