              ...
              >
                {updates.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      <span className="text-white text-[25px] font-medium text-base  whitespace-nowrap overflow-hidden text-ellipsis mr-1 group-hover:text-red-400 transition-colors">
                        {item.text}
                      </span>
