              ...
              {updates.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <CircleArrowOutUpRight className="w-2 h-2 text-red-400 flex-shrink-0 ml-1" />
                  </Link>
                </div>
              ))}
            </div>
                ...
                {navLinks.map((link, index) => {
                  ...
                  return (
                    ...
                    >
                      <Link
                        to={link.path}
                        className={`flex items-center text-xl py-3 text-white hover:text-red-400 transition-colors ${location.pathname === link.path ? 'font-bold text-red-500' :'text-white hover:text-red-400'  'font-medium'
                          }`}
