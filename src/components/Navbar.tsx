              ...
              >
                {updates.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      <span className="text-white text-[12px] font-medium text-base lg:text-lg whitespace-nowrap overflow-hidden text-ellipsis mr-1 group-hover:text-red-400 transition-colors">
                        {item.text}
                      </span>
