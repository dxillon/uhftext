...
import { Menu, X, ExternalLink, Home, Users, Info, Folder,LibraryBig } from 'lucide-react';
    ...
    <nav className="fixed w-full z-50 mt-5">
      <div className="max-w-screen-4xl mx-auto px-8 sm:px-10 lg:px-20 relative">
        ...
        <div className="relative z-1 flex items-center justify-between h-12 md:h-20 px-0">
          ...
          {/* Desktop Nav */}
          <div className="hidden md:flex items-center space-x-10 -pr-10">
            {navLinks.map((link) => {
...
<GlassMorphButton
  to="/courses"
  className=" group px-4 py-2.5 text-[22px] font-medium text-white text-base rounded-full flex items-center gap-1.5 relative"
>
