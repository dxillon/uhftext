        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Find answers to commonly asked questions about our film production services
            </p>
            ...
            <div onClick={() => handleFeaturedClick(faq.id)} className="cursor-pointer">
              <div className="w-full px-6 py-4 flex items-center justify-between">
                <div className="flex items-start gap-3">
                  <div className="flex items-center gap-1 text-xs bg-gray-800/70 rounded-full px-2 py-1">
...
{!noResults && !searchTerm && (
  <div className="flex justify-center py-8 bg-transparent">
    <div className="flex items-center gap-4 bg-red-900/20 border border-red-900/30 rounded-full px-6 py-3 shadow-md">
      <h4 className="text-white/80 text-sm whitespace-nowrap">
        Didn't find what you're looking for?
      </h4>
      <Link
        to="/contact"
        className="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm rounded-full transition-colors"
      >
        Contact Us
        <ArrowRight className="w-4 h-4 ml-2" />
      </Link>
