...
const mainTeam = [
  {
    ...
    image: "https://res.cloudinary.com/dbtj6orw2/image/upload/v1745866798/Untitled_design_6_vjnm4f.png",
            ...
            {Object.entries(departments).map(([department, { description, members }], index) => (
              <motion.div
                ...
                className={`card group overflow-hidden transition-all duration-300 ${
                  expandedDepartments[department] ? 'ring-2 ring-red-500/50' : ''
                }`}
              ...
              >
                ...
                <div 
                  className={`overflow-hidden transition-all duration-300 ${
                    expandedDepartments[department] ? 'h-auto' : 'h-[160px]'
                  }`}
                >
                  <div 
                    ref={el => scrollContainers.current[department] = el}
                    className={`transition-transform duration-1000 ${
                      expandedDepartments[department] ? 'translate-y-0!' : ''
                    }`}
                    style={{ 
                ...
                <div className={`mt-4 text-center text-xs text-gray-500 opacity-75 ${
                  expandedDepartments[department] ? 'block' : 'hidden'
                }`}>
